...
{ id:"medici", year:1397, date:"1397", era:1, cat:"power",
  ...
  importance:"Ferguson's account of the bond and banking revolutions begins in Renaissance Italy. Founded by Giovanni de' Medici in 1397, the Medici Bank used bills of exchange to move money across borders (and around the Church's usury ban), a branch network from London to Rome, and meticulous double-entry books. It financed the Renaissance and four Medici popes, and lifted a banking family into dukes and queens. The bank is Ferguson's emblem of how mastery of money converts into political power — a lesson the East India Company and modern finance restage.",
  impact:{
...
{ id:"johnlaw", year:1719, date:"1716–1720", era:2, cat:"power",
  ...
  importance:"Ferguson pairs the Mississippi Bubble with its London twin, the South Sea Bubble, as the founding disasters of the stock market. John Law — convicted duelist, gambler, monetary visionary — persuaded France to combine a central bank issuing paper money, the Mississippi Company monopoly, and the national debt into one self-reinforcing machine. Shares soared twentyfold, then collapsed in 1720, ruining thousands and poisoning France against banks and paper money for a century. Law grasped that money is confidence — and learned that confidence, once lost, takes everything with it.",
  impact:{
