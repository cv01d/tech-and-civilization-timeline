...
{ id:"thehouses", year:1851, date:"1835–1889", era:3, cat:"print",
  title:"The Great Newspaper Houses",
  wiki:"History of American newspapers",
  summary:"On the penny press's foundation rise the institutions of American journalism: Bennett's New York Herald (1835) professionalizes news-gathering as commerce, then Greeley's Tribune (1841), Raymond and Jones's New-York Times (1851), the Washington Post (1877), and Dow Jones's Wall Street Journal (1889) — while E.W. Scripps builds the first true newspaper chain in the 1880s.",
  importance:"The mid-century houses turned the penny press's business model into durable institutions, professionalizing reporting as a commercial enterprise and creating the great metropolitan dailies that would anchor American public life for a century. Scripps's chain introduced the other defining force — ownership at scale — the prototype for the consolidation that would later answer to shareholders rather than proprietors. These names are the substrate of the American public sphere, and the structures whose economic collapse, not any censor, would eventually hollow them out.",
  impact:{
    print:"The institutional metropolitan dailies of American journalism are founded.",
    power:"News-gathering becomes a professional commercial enterprise.",
    labor:"Scripps's first chain introduces newspaper ownership at scale." },
  causes:["pennypress","apwire"], effects:["yellowjournalism","newsweekly","crossownership"] },
...
{ id:"newsweekly", year:1923, date:"1923", era:4, cat:"print",
  ...
  causes:["thehouses","yellowjournalism"], effects:["crossownership"] },
